...
def main(opts, cfgs):
    ...
    for seq in seqs:
        ...
        loader = tracker_dataloader.TrackerLoader(path, opts.img_size, opts.data_format, seq, pre_process_method='v5',
                                                  model_stride=stride)
        ...
        for i, (img, img0) in enumerate(data_loader):
            ...
            if opts.save_images:
                plot_img(img0, frame_id, [cur_tlwh, cur_id, cur_cls],
                         save_dir=os.path.join(DATASET_ROOT, 'result_images', seq))
