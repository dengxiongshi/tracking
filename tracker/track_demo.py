...
SAVE_FOLDER = '/data/nanotracking/src/result'  # NOTE: set your save path here
...
if __name__ == '__main__':
    ...
    parser.add_argument('--obj', type=str, default=r'/data/nanotracking/src/test.mp4', help='video NAME or images FOLDER NAME')
    ...
    parser.add_argument('--model_path', type=str, default='/data/nanotracking/src/weights/best.pt', help='model path')
    ...
    """For tracker"""
    # model path
    parser.add_argument('--reid_model_path', type=str, default='/data/nanotracking/src/weights/ckpt.t7', help='path for reid model path')
    parser.add_argument('--dhn_path', type=str, default='/data/nanotracking/src/weights/DHN.pth', help='path of DHN path for DeepMOT')
