...
def parse_args():
    ...
    parser.add_argument("--config",default='nanodet-plus-m_416-yolo.yml', help="model config file path")
    parser.add_argument("--model", default='nanodet_model_best.pth', help="model file path")
    parser.add_argument("--path", default="../test.mp4", help="path to images or video")
...
class Predictor(object):
    ...
    def inference_from_tensor(self, img):
        img_info = {"id": 0}
        height, width = img.shape[:2]
        img_info["height"] = height
        img_info["width"] = width
