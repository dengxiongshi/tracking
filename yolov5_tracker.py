...
def parse_opt():
    ...
    parser.add_argument('--tracker', type=str, default='botsort', help='sort, deepsort, etc')
    """For tracker"""
    # model path
    ...
    parser.add_argument('--source', type=str, default=ROOT / 'datasets/test1.mp4', help='file/dir/URL/glob, 0 for webcam')
